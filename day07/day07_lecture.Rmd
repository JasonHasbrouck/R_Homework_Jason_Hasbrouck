...
ggplot(myris, aes(cm)) + geom_histogram() + xlab("centimeters")
                    ...
                    #(data, remove column)      spread(var1, var2)
...
# changing font
myris.scatter2 + scale_color_brewer(palette = "Set1", name = "Iris species") + theme(text = element_text(family = "serif", size = 20))
...
myris.scatter2 + scale_color_brewer(palette = "Set1", name = "Iris species") + theme(text = element_text(family = "awesome", size = 20))
